...
const Main = () => {
  return (
    <div className="flex overflow-y-hidden  gap-5 mx-[9%] justify-center items-center">
      <div className="2xl:mx-auto 2xl:container  lg:py-2 md:py-12 md:px-6 py-9 px-4  sm:w-auto">
