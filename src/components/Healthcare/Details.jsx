...
const Details = () => {
  return (
    <div className="overflow-y-hidden flex gap-5 mx-[10%]">
      <div className="py-12 px-4 w-[70%] md:px-6 lg:px-20 xl:px-40 2xl:px-0 2xl:container 2xl:mx-auto flex justify-center items-center flex-col">
      ...
      <div className="w-[30%] mt-8 md:mt-[7.5%]">
