...
const Details = () => {
  return (
    <div className="overflow-y-hidden flex md:flex-row flex-col gap-5 mx-[10%]">
      <div className="py-6 px-4 md:w-[70%] md:px-6 lg:px-0 xl:px-0 2xl:px-0 2xl:container 2xl:mx-auto flex justify-center items-center flex-col">
        ...
        <div className="mt-8 md:mt-5 md:px-0 lg:px-0 xl:px-0 w-full flex justify-center items-center space-y-10 flex-col">
