...
const Home = () => {
     ...
     const Img = [
       {
         ...
         Shares: "38 Shares",
         link: " Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consequatur itaque molestiae molestiae molestiae   ",
       },
       {
         img: "c2.jpg",
         tag: "5 Hours | campaign Team",
     ...
     const Img2 = [
       {
         img: "m2.webp",
         link: " Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consequatur    ",
       },
       {
         img: "m2.webp",
         link: " Lorem ipsum dolor sit, amet consectetur adipisicing elit. Consequatur    ",
  ...
  return (
    <div className="2xl:mx-auto 2xl:container xl:px-20 gap-7 lg:px-10 px-6">
      <div className="2xl:mx-auto flex md:flex-row flex-col 2xl:container xl:px-20 gap-7 lg:px-10 px-0">
        ...
        <div className="py-[2%] mb-5 bg-white shadow-lg md:h-[55vw]  md:w-[25%] ">
