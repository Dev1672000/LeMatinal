...
const MoreHealth = () => {
  return ( <div className="bg-indigo-50 relative mx-[10%] px-[1%] pb-[2%]">
       <div className="pt-14 xl:px-0 px-4">
            <div className="w-full xl:flex">
              <div className="xl:w-3/5 w-full">
                <div className="relative md:flex  mb-8 bg-white rounded-md shadow-md md:p-0 p-4">
                  <img
                    role="img"
                ...
                <div className="relative md:flex p-6  mb-8 bg-white justify-right items-center gap-x-2 shadow-md rounded-md">
                  <img
                    tabindex="0"
                    role="img"
                    aria-label="bag on a table"
                    ...
                    className=" focus:outline-none lg:w-32 md:w-48 flex-shrink-0 sm:w-auto w-full"
                  />
                ...
                <div className="relative z-20 md:flex p-6  mb-8 bg-white justify-right items-center gap-x-2  shadow-lg">
                  <img
                    tabindex="0"
                    role="img"
                    aria-label="bag on a table"
              ...
              <div className="xl:w-1/2 w-full xl:ml-8">
                <div className="relative md:flex p-6  mb-8 bg-white items-center gap-x-2 shadow-md rounded-md">
                  <img
                    tabindex="0"
                    role="img"
                    aria-label="bag on a table"
                ...
                <div className="relative z-20 md:flex p-6  mb-8 bg-white items-center gap-x-2 shadow-md rounded-md">
                  <img
                    role="img"
                    aria-label="bag on a table"
                    alt="bag on table"
                ...
                >
                  <div className="mt-14 flex items-right justify-end">
                    <button className="flex items-center justify-center mt-7  md:text-lg text-sm rounded f-m-m font-semibold text-indigo-700 focus:outline-none xl:leading-4 hover:underline hover:text-indigo-800">
                      See More
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-4 w-4"
